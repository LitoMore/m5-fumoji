/*
 * Portable adaptation changes Copyright (C) 2026 LitoMore.
 * The original engine and these changes are licensed under GPL-2.0-only.
 * Changes: portable system-call types, C tokenization fixes for GCC, and
 * obvious translation correctness fixes identified by compiler diagnostics.
 */
#include "engine.h"
#include "middle.h"
#include <stdio.h>
